...
/**
 * Resourceful controller for interacting with objetivoproblemas
 */
class ObjetivoProblemaController {
  /**
   * Show a list of all objetivoproblemas.
   * GET objetivoproblemas
   *
   * @param {object} ctx
  ...
  /**
   * Render a form to be used for creating a new objetivoproblema.
   * GET objetivoproblemas/create
   *
   * @param {object} ctx
   * @param {Request} ctx.request
   * @param {Response} ctx.response
  ...
  /**
   * Render a form to update an existing objetivoproblema.
   * GET objetivoproblemas/:id/edit
   *
   * @param {object} ctx
   * @param {Request} ctx.request
   * @param {Response} ctx.response

...
/**
 * Resourceful controller for interacting with produtoproblemas
 */
class ProdutoProblemaController {
  /**
   * Show a list of all produtoproblemas.
   * GET produtoproblemas
   *
   * @param {object} ctx
  ...
  /**
   * Render a form to be used for creating a new produtoproblema.
   * GET produtoproblemas/create
   *
   * @param {object} ctx
   * @param {Request} ctx.request
   * @param {Response} ctx.response
  ...
  /**
   * Render a form to update an existing produtoproblema.
   * GET produtoproblemas/:id/edit
   *
   * @param {object} ctx
   * @param {Request} ctx.request
   * @param {Response} ctx.response

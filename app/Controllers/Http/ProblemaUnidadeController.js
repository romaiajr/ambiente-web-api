...
/**
 * Resourceful controller for interacting with problemaunidades
 */
class ProblemaUnidadeController {
  ...
  /**
   * Render a form to be used for creating a new problemaunidade.
   * GET problemaunidades/create
   *
   * @param {object} ctx
   * @param {Request} ctx.request
   * @param {Response} ctx.response
  ...
  /**
   * Render a form to update an existing problemaunidade.
   * GET problemaunidades/:id/edit
   *
   * @param {object} ctx
   * @param {Request} ctx.request
   * @param {Response} ctx.response
